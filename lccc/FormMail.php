...
$mailprog = '/usr/sbin/sendmail -i -t -odb info@londoncomputercollege.co.uk';

# @referers allows forms to be located only on servers which are defined     #
# in this field.  This security fix from the last version which allowed      #
# anyone on any server to use your FormMail script on their web site.        #

@referers = ('londoncomputercollege.co.uk');
...
$captcha_datadir = "/websites/123reg/LinuxPackage22/lo/nd/on/londoncomputercollege.co.uk/public_html/.captcha_data";
...
$captcha_outputdir = "/websites/123reg/LinuxPackage22/lo/nd/on/londoncomputercollege.co.uk/public_html/mailform/img";
...
sub send_mail {
    ...
    else                    { print MAIL "Subject: Communication from visitor to website londoncomputercollege.co.uk\n\n" }
